...
function createScene(scene) {
    ...
    let geo = new THREE.SphereBufferGeometry(0.5, 5, 5).toNonIndexed();
    geo.computeVertexNormals();
    window.sphereMesh  = new THREE.Mesh(geo, new THREE.ShaderMaterial({
        uniforms: {
            "uEmissive": { value: new THREE.Vector3(0,0,0) },
            "uAlbedo": { value: new THREE.Vector3(1,1,1) },
            "uRoughness": { value: 0 },
        ...
        fragmentShader: standardMaterial_fs, 
        vertexShader: standardMaterial_vs,
